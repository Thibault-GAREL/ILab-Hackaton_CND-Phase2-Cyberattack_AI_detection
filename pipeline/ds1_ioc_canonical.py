...
def canonicalize_ds1_indicators(challenge_id: str, indicators: dict[str, Any]) -> dict[str, Any]:
    ...
    if challenge_id == "credential_stuffing":
        ...
        v = _pick_first(norm, ("total_ssh_failures", "failed_ssh"))
        if v is not None:
            out["total_ssh_failures"] = v
        ...
        v = _pick_first(norm, ("sqli_requests", "sqli_payloads"))
        if v is not None:
            out["sqli_requests"] = v
        ...
        ta = _pick_first(norm, ("traversal_attempts",))
        if ta is not None:
            out["traversal_attempts"] = ta
