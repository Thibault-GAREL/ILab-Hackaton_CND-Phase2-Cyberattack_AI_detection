...
def _load_dotenv() -> None:
    """Charge `.env` a la racine du projet (non versionne). Voir `.env.example`."""
    try:
...
# Dataset 2 / timelines libres : CND_DS1_CANONICAL_TIMELINE=0
DS1_CANONICAL_TIMELINE = _env_bool("CND_DS1_CANONICAL_TIMELINE", True)
# IoC : noms de cles alignes sur ground-truth-ds1.json (ds1_ioc_canonical). DS2 : CND_DS1_CANONICAL_IOCS=0
DS1_CANONICAL_IOCS = _env_bool("CND_DS1_CANONICAL_IOCS", True)
